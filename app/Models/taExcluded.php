...
class taExcluded extends Model
{
    use HasFactory;
    protected $table='ta_excluded';
    protected $primaryKey='excluded_id';
    protected $guarded = ['excluded_id'];
    ...
    public static function insertDetails($data) {
        return self::create($data)->excluded_id;
    }
