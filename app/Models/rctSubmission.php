...
class rctSubmission extends Model
{
    use HasFactory;
    protected $table='rct_submission';
    protected $primaryKey='submisstion_id';
    protected $guarded = ['submisstion_id'];
    ...
    public static function insertDetails($data) {
        return self::create($data)->submisstion_id;
    }
