...
Route::get(
    "/user/notify_bank_account_clients",
    [StatementController::class, "notify_bank_account_clients"]
);
Route::post(
...
Route::post(
    "/user/edit_statement_header_image",
    [StatementController::class, "edit_statement_header_image"]
);
