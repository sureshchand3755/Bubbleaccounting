...
Route::get(
    "/user/deactive_vat_clients_ajax",
    [UserController::class, "deactivevatclientsajax"]
);
Route::get(
...
Route::get("/user/dashboard_analytics", [UserController::class, "dashboard_analytics"]);
Route::get("/user/dashboard_system_summary", [UserController::class, "dashboard_system_summary"]);
Route::get("/user/dashboard", [UserController::class, "dashboard_user_details"]);
Route::get(
...
Route::get(
    "/user/rctclient_checkemail",
     [CmController::class, 'client_checkemail']  
);
...
Route::post(
    "/user/change_avathar_user_profile",
     [UserController::class, 'change_avathar_user_profile']  
);

Route::post(
    "/user/upload_user_avatar_images",
    [UserController::class, 'upload_user_avatar_images']
);
Route::post(
    "/user/show_cropped_image",
    [UserController::class, 'show_cropped_image']
);
Route::post(
    "/user/save_cropped_image",
    [UserController::class, 'save_cropped_image']
);
Route::post(
    "/user/edit_pms_header_image",
    [UserController::class, 'edit_pms_header_image']
);
Route::post(
    "/user/edit_paye_mrs_header_image",
    [UserController::class, 'edit_paye_mrs_header_image']
);

Route::post(
    "/user/edit_dashboard_header_image",
    [UserController::class, 'edit_dashboard_header_image']
);
Route::post(
    "/user/edit_vat_header_image",
    [UserController::class, 'edit_vat_header_image']
);
