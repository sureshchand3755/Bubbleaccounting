...
Route::post("get_user_practice_code", [UserauthenticateController::class, "get_user_practice_code"]);

Route::post("user/check_email_address", [UserauthenticateController::class, "check_email_address"]);
Route::post("user/verify_otp_register", [UserauthenticateController::class, "verify_otp_register"]);
Route::post("user/check_practice_name", [UserauthenticateController::class, "check_practice_name"]);
