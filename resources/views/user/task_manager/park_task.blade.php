...
.open_layout_div_change::before{width: 100%; height: 30px; content: ""; position: fixed; background: #fff; margin-top: 300px; z-index: 99}
	            ...
	            <tbody id="task_body_open">
	              ...
	              if(($user_tasks))
	              {
                    ...
                    if($task->two_bill == "1")
                    {
	                  ...
	                  $author = DB::table('user')->where('practice',Session::get('user_practice_code'))->where('user_id',$task->author)->first();
                    ...
                    if($task->auto_close == 1){
	                  ...
	                  <tr class="tasks_tr <?php echo $author_cls; ?>" id="task_tr_<?php echo $task->id; ?>">
                        ...
                        <?php
	                      ...
	                      <table class="table">
	                        <tr>
	                          ...
	                          <td style="width:75%;background: #E1E1E1">
                              <?php echo $title; ?> 
	                            ...
	                            if(($taskinfiles))
	                            {
	                              ...
	                              foreach($taskinfiles as $infile)
	                              {
	                                if($infile->status == 0)
	                                {
	                                  ...
	                                  $fileoutput.='<p class="link_infile_p"><a href="'.$ele.'" target="_blank" class="link_infile" data-element="'.$ele.'">'.$i.'</a>
	                                  <a href="'.$ele.'" target="_blank" class="link_infile" data-element="'.$ele.'">'.date('d-M-Y', strtotime($file->data_received)).'</a>
	                                  <a href="'.$ele.'" target="_blank" class="link_infile" data-element="'.$ele.'">'.$file->description.'</a>
	                    ...
	                    <td style="vertical-align: baseline;background:#E8E8E8;width:30%">
	                      <table class="table">
	                        <tr>
	                          ...
	                          <td style="width:75;background:#E8E8E8"><?php echo $author->lastname.' '.$author->firstname; ?> 
	                          <?php
	                        ...
	                        <tr>
	                          <td style=";font-weight:700;text-decoration: underline;background:#E8E8E8">Allocated to:</td>
	                          <td id="allocated_to_name_<?php echo $task->id; ?>" style="background:#E8E8E8"><?php echo $allocated_to; ?></td>
	                        </tr>
	                        <tr>
	                        ...
	                        <tr>
	                          <td style="background:#E8E8E8" colspan="2" id="allocation_history_div_<?php echo $task->id; ?>" class="<?php echo $disabled_icon; ?>">
	                            <?php
	                    ...
	                    <td style="vertical-align: baseline;background: #F0F0F0;width:20%">
	                      <table class="table">
	                        <tr>
	                          <td style="font-weight:700;text-decoration: underline;background: #F0F0F0">Progress Files:</td>
	                          <td style="background: #F0F0F0"></td>
	                        </tr>
	                        <tr>
	                          <td style="background: #F0F0F0" class="<?php echo $disabled_icon; ?>">
	                        ...
	                        <tr>
	                          <td style="background: #F0F0F0" colspan="2" class="<?php echo $disabled_icon; ?>">
	                            <?php
          ...
          <table class="table_bg table-fixed-header table_layout" style="width:100%;float:left;display:none; border:0px;">
          	<thead>
          		<tr class="hidden_tasks_th" id="menulist">
                    <td style="background: #fff;padding:0px;border-bottom:3px solid #000;border-right: 0px solid">
                    	<table style="width:100%">
                            ...
                            <td style="color:#000;width:10%;padding:10px; font-size:15px; font-weight:600;">Task <br/>ID<i class="fa fa-sort taskid_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></td>
                            ...
                            <td style="color:#000;width:10%;padding:10px; font-size:15px; font-weight:600;">Active <br/>Client<i class="fa fa-sort taskid_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></td>
    ...
    if(layout == "1")
    {
      $(".open_layout_div").addClass("open_layout_div_change");
    	...
    	if(open_tasks_height < 50)
    	{
        	...
        	$(".table_layout").css("margin-top","262px");
        }
    }
    else{
