      ...
      <div class="modal-body">
          ...
          <div class="row" style="margin-top:10px">
            ...
            <div class="col-md-12">
                ...
                <label style="margin-top:10px" id="task_report_label">Task_Report_For_Year-<?php echo $yearname->year_name; ?>_Month-<?php echo $monthid->month; ?>.pdf</label>

                <label style="margin-top:10px" id="notify_report_label">Notify_Report_For_Year-<?php echo $yearname->year_name; ?>_Month-<?php echo $monthid->month; ?>.pdf</label>
...
<div class="select_button">
      <ul style="margin-right: 1%;float:right">
        ...
        $prev_month = DB::table('pms_month')->where('month_id','<',$this_month)->where('year',$monthid->year)->orderBy('month_id','desc')->first();
        $next_month = DB::table('pms_month')->where('month_id','>',$this_month)->where('year',$monthid->year)->orderBy('month_id','asc')->first();
