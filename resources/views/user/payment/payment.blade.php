...
body.loading_blur .modal_load_blur {
    display: block;
}
...
$get_imported_receipts = DB::table('payments')->where('practice_code',Session::get('user_practice_code'))->where('imported',1)->get();
if(($get_imported_receipts))
{
  DB::table('payments')->where('practice_code',Session::get('user_practice_code'))->where('imported',1)->delete();
}
?>
...
<div class="modal fade edit_payment_overlay" id="edit_payment_overlay" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" data-backdrop="static" data-keyboard="false" style="margin-top:5%">
  <div class="modal-dialog modal-sm" role="document" style="width:80%">
      <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          ...
          <div class="modal-body">
              <h4><strong>Payment Status: </strong><spam class="payment_status_edit_title"></spam></h4>
              <h4><strong>Journal ID: </strong><spam class="journal_id_edit_title"></spam></h4>

              <h4 style="margin-top:20px;font-weight:600">Current Payment Details:</h4>
              <table class="table">
                <thead>
                  <th style="width:10%">Date</th>
                  <th style="width:20%">Debit Nominal</th>
                  <th style="width:15%">Credit Nominal & Description</th>
                  <th style="width:10%">Client/Supplier Code</th>
                  <th style="width:20%">Debit Nominal Description</th>
                  <th style="width:15%">Comment</th>
                  <th style="width:10%">Amount</th>
                </thead>
                <tbody>
                  <tr>
                    <td class="payment_date_edit" style="border-bottom: 1px solid #dfdfdf"></td>
                    ...
                    <td class="debit_description_edit" style="border-bottom: 1px solid #dfdfdf"></td>
              ...
              <div class="col-md-12 text-center">
                <a href="javascript:" class="fa fa-arrow-circle-down transfer_current_to_new" title="Transfer Details from Current Payment to New Payment" style="font-size: 35px;text-decoration: none"></a>
              </div>
              <h4 style="margin-top:45px;font-weight:600">New Payment Details:</h4>
              <table class="table" width="100%">
                <thead>
                  <tr>
                      <th style="text-align: left;width:10%">Date</th>
                      <th style="text-align: left;width:20%">Debit Nominal</th>
                      <th style="text-align: left;width:15%">Credit Nominal & Description</th>
                      <th style="text-align: left;width:10%">Client/Supplier Code</th>
                      <th style="text-align: left;width:20%">Debit Nominal Description</th>
                  ...
                  <tr>
                    ...
                    <td>
                      <select name="credit_nominal_update" class="form-control credit_nominal_update">
                        <option value="">Select Nominal</option>
                        <?php
                        $payment_nominals = DB::table('payment_nominal_codes')->where('practice_code',Session::get('user_practice_code'))->orderBy('code','asc')->get();
                    ...
                    <td><input type="text" name="debit_descripion_update" class="form-control debit_descripion_update" value="" readonly></td>
                    ...
                    <td>
                      ...
                      <input type="hidden" name="hidden_payment_id_update" class="hidden_payment_id_update" value="">
                    </td>
                  </tr>
                </tbody>
            </table>
            <p class="error error_edit_payment" style="font-size: 15px"></p>
            <input type="hidden" name="hidden_edit_payment_id" class="hidden_edit_payment_id" value="">
            <div class="col-md-12 text-center">
                <a href="javascript:" class="common_black_button save_editted_payment_details">Save Edited Details</a>
            </div>
          </div>
          <div class="modal-footer" style="margin-top:20px;clear: both;">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link" href="javascript:" style="cursor:not-allowed">Receipt</a>
                </li>
                <li class="nav-item active">
                  <a class="nav-link" style="background: #f0f0f0;" href="javascript:">Payment</a>
                </li>
              </ul>
            <div class="col-md-12" style="background: #ececec;">
              ...
              <div class="col-md-12" style="margin-top:20px;padding:0px">
                  <div class="col-md-6" style="padding:0px;border-right:1px solid #ccc">
                      <table class="table">
                          <thead>
                              <th colspan="2" style="border-top: 1px solid #ccc;border-left: 1px solid #ccc;text-align: center;"><h4>New Payment Entry</h4></th>
                          </thead>
                          <tbody>
                              <tr>
                  ...
                  <div class="col-md-6" style="padding:0px">
                      <table class="table">
                          <thead>
                              <th colspan="2" style="border-top: 1px solid #ccc;border-right: 1px solid #ccc;text-align: center;"><h4>New Receipt Entry</h4></th>
                          </thead>
                          <tbody>
                              <tr>
                                  <td style="border:0px"><label>Date:</label></td>
          ...
          <div class="modal-footer" style="margin-top:20px;clear: both;">
              <input type="hidden" name="hidden_bank_transfer_payment_id" class="hidden_bank_transfer_payment_id" id="hidden_bank_transfer_payment_id" value="">
          </div>
        @csrf
</form>
      </div>
...
<div class="modal fade" id="batch_analysis_overlay" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" data-backdrop="static" data-keyboard="false" style="margin-top:5%">
  <div class="modal-dialog modal-sm" role="document" style="width:50%">
      <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">Payment Batch Analysis</h4>
          </div>
          <div class="modal-body">
      ...
      <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close close_batch_overlay" data-dismiss="modal" aria-label="Close"><span class="close_batch_overlay" aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">Payment Batch Review</h4>
          </div>
          <div class="modal-body">
                ...
                <table class="table">
                    <thead>
                      <tr style="background: #fff;">
                          <th width="8%" style="text-align: left;">Date <i class="fa fa-sort date_batch_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
                          <th width="8.5%" style="text-align: left;">Debit Nominal <i class="fa fa-sort debit_batch_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
                          <th width="15%" style="text-align: left;">Credit Nominal & Description <i class="fa fa-sort credit_batch_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
                          <th width="10%" style="text-align: left;">Client/Supplier Code <i class="fa fa-sort client_batch_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
                          <th width="15%" style="text-align: left;">Debit Nominal Description <i class="fa fa-sort des_batch_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
                          ...
                          <th width="6%" style="text-align: right;">Amount <i class="fa fa-sort amount_batch_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
                          <th width="7%" style="text-align: right;">Journal&nbsp;ID <i class="fa fa-sort journal_batch_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
                          <th width="8%" style="text-align: left;">Status <i class="fa fa-sort status_batch_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
                      </tr>
                    </thead>                            
              ...
              <div style="width:100%;margin-top:20px;text-align: center">
                ...
                <a href="javascript:" class="common_black_button delete_outstanding_payments">Delete Outstanding Transactions</a>
              </div>
          </div>
          <div class="modal-footer" style="margin-top:20px;clear: both;">
        ...
        <h4>Payments List</h4>
            <div class="col-lg-8 padding_00">
              ...
              <div class="col-md-4 client_div" style="display:none">
                ...
                <img class="active_client_list_pms" src="<?php echo URL::to('public/assets/images/active_client_list.png'); ?>" style="width:24px; cursor:pointer; margin-top:5px;margin-left:6px;" title="Add to active client list" />
              ...
              <div class="col-md-4 credit_nominal_div" style="display:none">
                ...
                <select name="credit_nominal" class="form-control credit_nominal_receipt" style="width:60%;float:left;margin-left:10px">
                    <option value="">Select Nominal</option>
                    <?php
                    $receipt_nominals = DB::table('payment_nominal_codes')->where('practice_code',Session::get('user_practice_code'))->orderBy('code','asc')->get();
                    if(($receipt_nominals))
                    {
        ...
        <table class="table" id="client_expand" width="100%" style="margin-top: 10px;">
            <thead>
              <tr style="background: #fff;">
                  ...
                  <th width="10%" style="text-align: left;">Client/Supplier Code <i class="fa fa-sort client_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
                  ...
                  <th width="7%" style="text-align: right;">Journal&nbsp;ID <i class="fa fa-sort journal_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
                  <th width="8%" style="text-align: left;">Status</th>
                  <th width="14%" style="text-align: left;">Action <i class="fa fa-sort action_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
              </tr>
            </thead>                            
          ...
          if(payment_id == "")
          {
            $.ajax({
              ...
              success:function(result)
              {
                ...
                that.parents("tbody").find("tr:last").find(".hidden_payment_id").val("");
                $("body").removeClass("loading");
                ajax_function();
              }
            });
...
function ajax_function()
{
  ...
  $(".client_code_update").autocomplete({
    source: function(request, response) {
      var debit_nominal = $('.client_code_update:focus').parents("tr").find(".debit_nominal_update").val();
      $.ajax({
        url:"<?php echo URL::to('user/payment_common_client_search'); ?>",
        dataType: "json",
        data: {
    ...
    minLength: 1,
    select: function( event, ui ) {
      $(this).parents("tr:first").find(".debit_descripion_update").val(ui.item.company);
      $(this).parents("tr:first").find(".client_code_update").css("border-color","#ccc");
      $(this).parents("tr:first").find(".debit_descripion_update").css("border-color","#ccc");
    }
  });
...
function check_import_function(filename,round,total_count,kval)
{
  $.ajax({
      ...
      type: 'get',
      dataType:"json",
      data: {filename:filename,round:round,total_count:total_count,kval:kval},
      success: function (data) {
...
function load_all_payments(page,total_pages=1){
  if(page == "1") { $("body").addClass('loading'); }
  $.ajax({
    url:"<?php echo URL::to('user/load_all_payment'); ?>",
    type:"post",
    data:{page:page},
    dataType:"json",
    success:function(result)
    {
      ...
      if(total_pages == 0) {
        ...
        if(page == total_pages) {
          ...
          load_all_payments(nextpage,total_pages);
        }
      }
    }
  })
...
$(window).click(function(e) {
  ...
  {
    $("body").addClass("loading");
    var payment_id = $(e.target).attr("data-element");
    $.ajax({
      url:"<?php echo URL::to('user/edit_payment_details'); ?>",
      type:"post",
      data:{payment_id:payment_id},
      dataType:"json",
      success:function(result){
        $(".edit_payment_overlay").modal("show");
        $(".hidden_edit_payment_id").val(payment_id);
        $(".payment_status_edit_title").html(result['status']);
        $(".journal_id_edit_title").html(result['journal_id']);

        $(".payment_date_edit").html(result['payment_date']);
        ...
        $(".debit_description_edit").html(result['debit_description']);
        ...
        if(result['locked'] == "1"){
          $(".credit_nominal_update").val(result['credit_nominal_code']);
          $(".credit_nominal_update").prop("disabled",true);
        }
        else{
          $(".credit_nominal_update").val("");
          $(".credit_nominal_update").prop("disabled",false);
        }

        $(".date_add_update").val("");
        $(".client_code_update").val("");
        $(".hidden_client_code_update").val("");
        $(".debit_descripion_update").val("");
        $(".comment_update").val("");
        $(".amount_update").val("");
...
$(window).change(function(e) {
  ...
  if($(e.target).hasClass('debit_nominal_update'))
  {
      var code = $(e.target).val();
      if(code == "")
      {
        ...
        $(e.target).parents("tr:first").find(".debit_descripion_update").val("");
      }
      else{
        if(code == "813A")
        {
        ...
        else
        {
          $(e.target).parents("tr:first").find(".client_code_update").val("");
          $(e.target).css("border-color","#ccc");
          $(e.target).parents("tr:first").find(".debit_descripion_update").css("border-color","#ccc");
          ...
          $.ajax({
            ...
            success:function(result)
            {
              $(e.target).parents("tr:first").find(".debit_descripion_update").val(result);
            }
          })
        }
      }
...
if($(e.target).hasClass('transfer_current_to_new')){
  var payment_date = $(".payment_date_edit").html();
  ...
  var debit_description = $(".debit_description_edit").html();
  ...
  if(client_code != ""){
    ...
    $(".client_code_update").val(debit_description);
...
if($(e.target).hasClass('save_editted_payment_details')){
  ...
  var des = $(".debit_descripion_update").val();
  ...
  if(i == 0){
    var payment_id = $(".hidden_edit_payment_id").val();
    $.ajax({
      url:"<?php echo URL::to('user/update_payment_details_editted'); ?>",
      type:"post",
      data:{date:date,debit:debit,credit:credit,des:des,client_code:client_code,comment:comment,amount:amount,payment_id:payment_id},
      dataType:"json",
      success:function(result)
      {
        $(".edit_payment_overlay").modal("hide");

        $(".receipt_payment_"+payment_id).find("td").eq(0).html('<spam class="date_sort_val" style="display:none">'+result['strtotime']+'</spam>'+date);
        $(".receipt_payment_"+payment_id).find(".debit_sort_val").html(debit);
        $(".receipt_payment_"+payment_id).find(".credit_sort_val").html(result['credit_nominal']);
        $(".receipt_payment_"+payment_id).find(".client_sort_val").html(client_code);
        $(".receipt_payment_"+payment_id).find(".des_sort_val").html(des);
        $(".receipt_payment_"+payment_id).find(".comment_sort_val").html(comment);
        $(".receipt_payment_"+payment_id).find("td").eq(6).html('<spam class="amount_sort_val" style="display:none">'+amount+'</spam>'+result['amount']);

        $.colorbox({html:'<p style="text-align:center;margin-top:10px;font-size:18px;font-weight:600;color:#000">Payment Updated Successfully.</p>',fixed:true,width:"800px"});
      }
    });
  }
  else{
...
if($(e.target).hasClass('batch_review_btn'))
{
  ...
  $.ajax({
    url:"<?php echo URL::to('user/show_payments_batch_list'); ?>",
    type:"post",
    success: function(result){
...
if($(e.target).hasClass('show_batch_overlay'))
{
  ...
  $.ajax({
    url:"<?php echo URL::to('user/show_batch_payment_informations'); ?>",
    type:"post",
    data:{batch_id:id},
    dataType:"json",
    success:function(result){
...
if($(e.target).hasClass('delete_outstanding_payments'))
{
  ...
  if(outstanding == "0")
  {
    ...
    if(r)
    {
      ...
      $.ajax({
        url:"<?php echo URL::to('user/delete_outstanding_payments_from_batch'); ?>",
        type:"post",
...
if($(e.target).hasClass('close_batch_overlay'))
{
  ...
  if($('.filter_btn').is(':visible')) {
    var filter_option = $(".filter_payment").val();
    if(filter_option != ""){
...
if($(e.target).hasClass('review_receipt_payment_entry'))
{
  ...
  $(".payment_entry_credit").html(credit);
  ...
  $(".payment_entry_credit").find(".fa-lock").detach();
...
if($(e.target).hasClass('bank_transfer_button'))
{
    var payment_id = $(e.target).attr("data-element");
    $.ajax({
        url:"<?php echo URL::to('user/get_payment_bank_transfer_details'); ?>",
        type:"post",
        data:{payment_id:payment_id},
        success:function(result)
        {
            ...
            $("#hidden_bank_transfer_payment_id").val(payment_id);
...
{
  $("body").addClass("loading");
  var payment_id = $('#hidden_bank_transfer_payment_id').val();
  $.ajax({
    url:"<?php echo URL::to('user/prepare_payment_receipt_entry'); ?>",
    type:"post",
    data:{payment_id:payment_id},
    success:function(result){
      $(".receipt_payment_"+payment_id).find(".debit_sort_val").html("770");
      $(".receipt_payment_"+payment_id).find(".bank_transfer_button").removeClass("bank_transfer_button").addClass("ticon");
      $(".receipt_payment_"+payment_id).find(".ticon").html('<img src="<?php echo url('public/assets/images/t-icon-disable.png'); ?>" style="width:20px">')
      $(".receipt_payment_"+payment_id).find(".ticon_span").html("0");
...
{
  $("body").addClass("loading_blur");
  $(".alert_modal").modal("hide");
  $("#bank_transfer_overlay").modal("hide");
  
  setTimeout(function() { $(".body_bg").css("padding-right","0px"); },1000);
  setTimeout(function() { $("body").removeClass("loading_blur"); },3000);
