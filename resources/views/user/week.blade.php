...
<div class="content_section">
  <div class="page_title">
    ...
    <div class="select_button">
        ...
        <p style="float:left;clear: both;margin-top:15px"><?php echo $current_week_btn; ?></p>
        <?php echo $payroll_list_btn; ?>
        <p style="clear: both;font-size: 18px;font-weight: 800;color: #000; position: absolute;bottom:8%;text-align: center;width: 98%;">You are In Weekly Payroll Task Management</p>
    </div>
</div>
