...
<div class="modal fade sent_to_client" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog" role="document" style="width:40%">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Email Selected Invoice PDF's</h4>
      </div>
      <div class="modal-body">
          <div class="row">
            <div class="col-md-1">
          ...
          <div class="row" style="margin-top:10px">
            ...
            <div class="col-md-5">
              ...
              $car_settings = DB::table("clientaccountreview_settings")->where('practice_code',Session::get('user_practice_code'))->first();
				  $admin_cc = $car_settings->client_account_cc_email;
				?> 
          ...
          <div class="row" style="margin-top:10px">
            ...
            <div id="client_attachments">
            	<h4 style="margin-top: 18px;margin-left: 15px;clear: both;float: left;width: 100%;font-weight:600">Attachment:</h4>
            	<img class="zip_image" src="<?php echo URL::to('public/assets/images/zip.png'); ?>" style="width:30px;margin-left: 15px;">
              <img class="pdf_image" src="<?php echo URL::to('public/assets/images/pdf.png'); ?>" style="width:30px;margin-left: 15px;">
...
<div class="modal fade invoice_modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" data-keyboard="false" data-backdrop="static" style="z-index: 9999999999999999999999999999">
  ...
  <div class="modal fade car_settings_modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" data-backdrop="static" data-keyboard="false" style="margin-top: 5%;">
    <div class="modal-dialog modal-sm" role="document" style="width:40%">
          <div class="modal-content">
            <form name="car_settings_form" id="car_settings_form" method="post" action="<?php echo URL::to('user/save_car_settings'); ?>">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title job_title" >Client Account Review Settings</h4>
              </div>
              <div class="modal-body">  
                  ...
                  <h4>Client Account Review CC Email ID:</h4>
                  <input id="validation-cc-email"
                         class="form-control"
                         placeholder="Enter Client Request CC Email ID"
                         value="<?php echo $car_settings->client_account_cc_email; ?>"
                         name="client_account_cc_email"
                         type="text"
                         required> 
                  <h4>Email Signature:</h4> 
                  <textarea name="email_signature" id="editor_car"><?php echo $car_settings->email_signature; ?></textarea>
              </div>
              <div class="modal-footer" style="clear:both">
                <input type="submit" class="common_black_button" id="car_submit" value="Submit">
              </div>
            @csrf
  </form>
          </div>
...
<div class="modal fade change_header_image" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
  <div class="modal-dialog modal-sm" style="width:30%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="<?php echo URL::to('user/edit_car_header_image'); ?>" method="post" enctype="multipart/form-data" class="dropzone" id="ImageUploadEmail" style="clear:both;min-height:80px;background: #949400;color:#000;border:0px solid; height:250px; width:100%; float:left">
...
<div class="content_section" style="margin-bottom:200px">
  	<div class="page_title">
        <h4 class="col-lg-12 padding_00 new_main_title">
            ...
            <a href="javascript:" id="settings_client_account" class="fa fa-cog common_black_button" title="Client Account Review Settings" style="float:right"></a>      
        </h4>
...
$(window).click(function(e) { 
  if(e.target.id == "settings_client_account")
  {
    $(".car_settings_modal").modal("show");
  }
  ...
  if($(e.target).hasClass('save_pdfs_in_folder'))
  {
	...
	if($(e.target).hasClass('email_selected_pdf'))
	{
        ...
        dataType:"json",
          ...
          CKEDITOR.instances['editor_1'].setData("<p>Hi,</p><p>We have attached a copy of the following Invoices</p>"+result['pdfs']+"<br/><br/><p>"+result['signature']+"</p>");
    ...
    init: function() {
        ...
        this.on("success", function(file, response) {
            ...
            if(obj.error == 1) {
              ...
              $.colorbox({html:'<p style="text-align:center;margin-top:26px;font-size:18px;font-weight:600">Client Account Review Image has been Changed Successfully.</p>',fixed:true,width:"800px"});
            }
        });
