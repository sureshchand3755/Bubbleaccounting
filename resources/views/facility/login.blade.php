...
<section class="login-block" style="height: 100%;">
  <div class="container">
    <div class="row" style="height: 670px;margin-top: 8%;">
      <div class="col-md-4 login-sec">
        ...
        <h2 class="text-center">Facility Admin Login</h2>
        ...
        <form action="<?php echo URL::to('facility/login'); ?>" method="post" class="login-form">
          ...
          <div class="form-group">
            <label for="exampleInputPassword1" class="text-uppercase">Practice Code:</label>
            <input type="text" name="practice_code" class="form-control" placeholder="Enter Practice Code" required>
          </div>
          <div class="form-check" style="padding: 0px;">
            <button type="submit" class="btn btn-login ">Submit</button>
            <label class="form-check-label float-right">
              <a href="<?php echo URL::to('facility/forgot_password'); ?>"><strong>Forgot Password?</strong></a>
            </label>
